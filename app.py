...
# --- Đảm bảo f(x_array) trả về mảng float ---
...
if method in ["Hình thang", "Cả hai"]:
    ...
    if fill_toggle:
        for i in range(n_t):
            ...
            fig.add_trace(go.Scatter(x=xs, y=ys, fill="toself", fillcolor="rgba(255,0,0,0.25)", line=dict(color="rgba(255,0,0,0.2)"), showlegend=False))
